...
import { FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaYoutube, FaPinterest, FaTiktok, FaGithub, FaMedium, FaStackOverflow, FaKickstarter} from 'react-icons/fa';
import { SiFiverr, SiUpwork, SiFreelancer, SiGofundme } from "react-icons/si";
  ...
  const profileTab = [
    {
      key: "My Profile",
      label: (
          <label style={{ fontSize: '18px', fontWeight: '600', cursor: 'pointer' }}>My Profile</label>
      ),
      children: (
          <>
                ...
                <div className={"py-6 pt-4"}>
                  <div className={"w-full xl:ps-[25px]"}>
                    <div className={"flex gap-3  md:items-center "}>
                      <p className={"font-bold text-base md:w-[25%] w-[22%] lg:w-[16%] sm-w-[50%]"}>
                        Company Name:
                      </p>
                          ...
                          <div className="flex">
                            {user.socialMediaLinks.map((item, index) => (
                                <div key={index} className="mr-2">
                                  <Tooltip title={item.platform + ' - ' + item.link} className={'capitalize'}>
                                    <a className={'pointer'} href={'#'}>{socialMediaIcons[item.platform]}</a>
                                  </Tooltip>
                                </div>
                            ))}
                          </div>
    ...
    },
    {
      key: "My Documents",
      label: (
          <label style={{ fontSize: '18px', fontWeight: '600', cursor: 'pointer' }}>My Documents</label>
      ),
      children: (
          <>
            <div className={"w-full"}>
    ...
    },
    {
      key: "Upcoming Events",
      label: (
          <label style={{ fontSize: '18px', fontWeight: '600', cursor: 'pointer' }}>Upcoming Events</label>
      ),
      children: (
          <>
            <div className={"w-full"}>
    ...
    },
    {
      ...
      label: (
          <label style={{ fontSize: '18px', fontWeight: '600', cursor: 'pointer' }}>Opportunities Alert</label>
      ),
      children: (
          <>
    ...
    },
    {
      key: "Announcements",
      label: (
          <label style={{ fontSize: '18px', fontWeight: '600', cursor: 'pointer' }}>Announcements</label>
      ),
      children: (
          <>
            <div className={"w-full border p-6"}>
