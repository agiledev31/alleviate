  ...
  const loadMorePrograms = useCallback(
    async (filters = {}, text = "") => {
      ...
      try {
        ...
        if (hasInvitedEmails) {
          const data = {
            filters: { published: true, ...filters, invitedEmails: {$in: [user.email]} }
          };
          const updatedResponse = await CrudService.search("Suite", 9,  page, {filters: { published: true}});
          ...
          <div style={{width: 'max-content'}}>
            ...
            >
              <BarsArrowUpIcon
                ...
                aria-hidden="true"
              />
              Category: {typeFilter !== "ALL" ? categories.find(item => item._id === typeFilter)?.Name : "All"}
            </Menu.Button>
          </div>
          <Transition
            as={Fragment}
            ...
            >
              <div className="px-6 py-4">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <Tooltip title={programType?.favoriteBy.includes(user._id) ? 'Remove from Favorite': 'Add to Favorite'}>
              ...
              <div className="px-6 pt-4 pb-2">
                <button
                  ...
                  onClick={() => {
                    navigate(`/dashboard/programoverview?id=${programType._id}`);
                  }}
                >
                  View
                </button>
