                      ...
                      <div className="flex items-center justify-between mt-2">
                          ...
                          <div>
                              <AiOutlineArrowRight
                                  ...
                                  onClick={() => {
                                      navigate(`/dashboard/suiteoverviewdetail?id=${programData._id}&tab=kpis`);
                                  }}
                              />
                          </div>
                      </div>
                      <div className="flex items-center justify-between mt-3">
                          ...
                          <div>
                              <AiOutlineArrowRight
                                  size={25} className="cursor-pointer"
                                  onClick={() => {
                                      navigate(`/dashboard/suiteoverviewdetail?id=${programData._id}&tab=assessments`);
                                  }}
                              />
                          </div>
                      </div>
                          ...
                          <MdFavorite
                              ...
                              onClick={async () => {
                                  ...
                                  await CrudService.update("Suite", id, {
                                      favoriteBy: programData.favoriteBy.filter(id => id !== user._id)
                                  }).then(res => {
                                      if (res.data) {
                                          setProgramData(res.data)
                                      }
